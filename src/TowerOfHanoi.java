...
public class TowerOfHanoi extends JFrame {
	...
	private JLabel lblScroll2;
	private JLabel lblScroll3;
	private JLabel label_2;
	private JLabel lblQuit;
	private JLabel lblQuit_1;
	private Quit frmQuit;
	private OpeningFrame frmOpeningFrame;
	private JLabel lblFrame1;
	...
	private void initialize() {
		...
		lblButtonIncrease.setBounds(38, 132, 83, 62);
		...
		lblTime.setFont(new Font("Clab Personal Use", Font.BOLD, 26));
		lblTime.setBounds(35, 312, 157, 34);
		getContentPane().add(lblTime);
		
		label_2 = new JLabel("TIME");
		label_2.setHorizontalAlignment(SwingConstants.CENTER);
		label_2.setForeground(SystemColor.desktop);
		label_2.setFont(new Font("Clab Personal Use", Font.BOLD, 26));
		label_2.setBounds(35, 322, 160, 25);
		...
		setLblTimeCount(new JLabel("0"));
		getLblTimeCount().setForeground(SystemColor.desktop);
		getLblTimeCount().setFont(new Font("Clab Personal Use", Font.BOLD, 56));
		getLblTimeCount().setBounds(97, 350, 149, 60);
		getContentPane().add(getLblTimeCount());
		...
		//JLabel with image for decoration
		lblScroll3 = new JLabel("");
		lblScroll3.setBounds(38, 322, 151, 88);
		contentPane.add(lblScroll3);
		path = "C:\\TreasureOfHanoiTheGame\\BackgroundImg\\Scroll.png"; 
		ImageIcon ScrollBg3 = new ImageIcon(path); 
		Image imgScrollBg3 = ScrollBg3.getImage(); 
		Image newScrollBg3 = imgScrollBg3.getScaledInstance(lblScroll3.getWidth(), lblScroll3.getHeight(),Image.SCALE_SMOOTH);
		ImageIcon newImgScrollBg3 = new ImageIcon(newScrollBg3);
		lblScroll3.setIcon(newImgScrollBg3);
		//JLabel with image for decoration
		...
		//Initialization of panel as new Tower of Hanoi with parameters of number of block.
		panel = new GamePlay(numberofBlock);
		...
		lblQuit_1.addMouseListener(new MouseAdapter() {
			...
			//music when mouse released and change of image to its original image
			@Override
			public void mouseReleased(MouseEvent e) {
				OpeningFrame.mouseMusic("C:\\TreasureOfHanoiTheGame\\SFXMusic\\click.wav");
				setVisible(false);
		...
		lblClassic.setFont(new Font("Cooper Black", Font.BOLD, 45));
		lblClassic.setHorizontalAlignment(SwingConstants.CENTER);
		lblClassic.setBounds(838, 59, 228, 60);
		contentPane.add(lblClassic);
		
		label_3 = new JLabel("CLASSIC");
		label_3.setHorizontalAlignment(SwingConstants.CENTER);
		label_3.setForeground(SystemColor.desktop);
		label_3.setFont(new Font("Cooper Black", Font.BOLD, 45));
		label_3.setBounds(838, 71, 228, 43);
	...
	public static void setLblTimeCount(JLabel lblTimeCount) {
		TowerOfHanoi.lblTimeCount = lblTimeCount;
	}
}
