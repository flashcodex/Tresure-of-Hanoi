...
public class InstructionAndAboutUs extends JFrame {
	//class properties
	...
	public InstructionAndAboutUs(int frame) {
		...
		lblExit.setBounds(662, 11, 66, 53);
		...
		if(frame==1) {
			path = "C:\\TreasureOfHanoiTheGame\\object\\Instructions.png"; 
		}
		else if (frame==2) {
			path = "C:\\TreasureOfHanoiTheGame\\object\\AboutUs.png"; 
		}
		...
		lblFrame.setBounds(-200, -16, 1085, 540);
